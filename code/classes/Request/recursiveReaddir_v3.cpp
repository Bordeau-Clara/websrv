...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   recursiveReaddir_v3.cpp                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aykrifa <aykrifa@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/11 08:21:10 by aykrifa           #+#    #+#             */
/*   Updated: 2026/02/09 13:30:44 by aykrifa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Request::generateAllFoldersContent(std::string subPath, std::string& htmlOutput)
{
    ...
    {
        htmlOutput += "  <div class=\"empty-folder\">📭 Empty folder</div>\n";
    }
    else
    {
        ...
        for (size_t i = 0; i < files.size(); i++)
        {
            ...
            htmlOutput += "        <div class=\"file-name\">";
...
bool Request::recursiveReaddir(std::string subPath)
{
    ...
    _response.body += "    .file-link { text-decoration: none; color: #2c3e50; display: block; }\n";
    ...
    _response.body += "    .file-name { font-weight: 500; word-break: break-word; }\n";
    _response.body += "    .file-link:hover .file-name { color: #3498db; }\n";
    ...
    _response.body += "          <span class=\"sidebar-folder-name\">. (root)</span>\n";
    _response.body += "        </div>\n";
    _response.body += "      </div>\n";
